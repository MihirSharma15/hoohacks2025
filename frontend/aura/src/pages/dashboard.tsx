...
export default function Dashboard() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: `This is a simulated response to: "${input}"` },
      ]);
    }, 1000);
  ...
  const getStockNews = (ticker: string) => {
    ...
    const newsMap: Record<string, {title: string, date: string}[]> = {
      'BSX': [
        {title: "Boston Scientific stock has gained 3% since Q4 earnings", date: "Feb 12, 2025"},
        {title: "BSX trading at US$95.65, overvalued by 26% compared to intrinsic value", date: "Jan 15, 2025"}
      ],
      'IRBT': [
        {title: "iRobot Corporation stock surges over 5%, reaching $8.73 per share", date: "Jan 17, 2025"}
      ],
      'KRG': [
        {title: "Raymond James drops price objective on Kite Realty Group Trust to $28.00", date: "Mar 11, 2025"},
        {title: "KeyBanc maintains Overweight rating with $31.00 price target", date: "Feb 19, 2025"}
      ],
      'FOX': [
        {title: "Wall Street analyst downgraded Fox's stock", date: "Jan 21, 2025"}
      ],
      'MAIN': [
        {title: "Main Street Capital Corporation selected in random stock pick", date: "Mar 26, 2025"}
      ]
    };
    ...
    <div className="flex h-screen bg-gray-100 relative">
      ...
      >
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className={`transition-transform ${sliderVisible ? "rotate-180" : ""}`}
        >
      ...
      >
        {sliderVisible && (
          <div className="p-4 overflow-y-auto h-full">
            <h3 className="text-lg font-medium mb-4 text-black">Stock Watchlist</h3>
                ...
                <div key={index} className="border rounded-md overflow-hidden">
                  ...
                  >
                    ...
                    <svg 
                      ...
                      strokeLinecap="round" 
                      strokeLinejoin="round"
                      className={`transition-transform ${expandedStocks.includes(ticker) ? 'rotate-180' : ''}`}
                    >
